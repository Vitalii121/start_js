...
//     document.write(`<div>${simpsons[i].name} - ${simpsons[i].surname} - ${simpsons[i].age} <p>${simpsons[i].info}</p> <img src="${simpsons[i].photo}" alt="photo"> </div>`)
// }
...
for (let i = 0; i < simpsons.length; i++) {
    ...
    document.write(`<img src="${simpsons[i].photo}" alt="photo"/>`)
    document.write(`</div>`)
}
...
//     document.write(`<img src="${products[i].image}" alt="img"/>`)
//     document.write(`</div>`)
// }
// document.write(`</div>`)
